...
(the power of the test, in this case when the p-value \< 0.05) on the y
axis and the true value of μ on the x axis.

-   **From the plot below, we see that as the true value of μ (the
    effect size) increases, the power of the test increases until it
    plateaus.**
